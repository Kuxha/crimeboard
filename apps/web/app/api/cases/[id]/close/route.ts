// API route for generating case file PDF
...
export async function POST(
    ...
    `, [caseId]);
        ...
        const pdfUrl = await getSignedReadUrl(key, 3600 * 24); // 24 hour expiry
